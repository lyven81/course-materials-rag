...
class TestCourseSearchTool(unittest.TestCase):
    ...
    def test_execute_successful_search(self):
        ...
        self.mock_vector_store.get_course_link.return_value = "http://example.com/course"
    ...
    def test_execute_no_results_with_filters(self):
        ...
        result = self.search_tool.execute("topic", course_name="Missing Course", lesson_number=5)
