...
class TestAIGenerator(unittest.TestCase):
    ...
    def test_generate_response_with_tool_use(self, mock_anthropic):
        ...
        mock_final_response.content = [Mock(text="Here's what I found about Python functions...")]
    ...
    def test_handle_tool_execution(self, mock_anthropic):
        ...
        self.assertEqual(final_call_args["messages"][1]["content"], mock_initial_response.content)
    ...
    def test_sequential_tool_calls_two_rounds(self, mock_anthropic):
        ...
        mock_final_response = Mock()
        mock_final_response.content = [Mock(text="Based on the course outline and search results, here's what I found...")]
    ...
    def test_sequential_tool_calls_early_termination(self, mock_anthropic):
        ...
        mock_round1_response = Mock()
        mock_round1_response.content = [Mock(text="This is a general knowledge answer that doesn't require tools.")]
    ...
    def test_sequential_tool_calls_with_tool_failure(self, mock_anthropic):
        ...
        self.assertEqual(result, "I encountered an error while searching for information.")
    ...
    def test_context_preservation_across_rounds(self, mock_anthropic):
        ...
        mock_client = Mock()
        mock_client.messages.create.side_effect = [mock_round1_response, mock_round2_response]
        mock_anthropic.return_value = mock_client
    ...
    def test_backward_compatibility_no_tool_manager(self, mock_anthropic):
        ...
        result = ai_gen.generate_response("What is Python?", tools=tools, tool_manager=None)
